# This code grabs specific statistics of all the food network txt files 
...
finalString = ""
files = os.listdir("foodNetworkOutput")
for textFile in files:
	temp=""
	out = ""
	filePath = "foodNetworkOutput/"+textFile
